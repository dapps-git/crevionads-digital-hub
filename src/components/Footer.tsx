    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          {/* LOGO + DESC */}
          <div>
            <img src={logo} alt="CrevionAds" className="h-10 mb-4" />
            ...
            <div className="flex gap-4 mt-6">
              <a href="#" target="_blank" className="text-zinc-400 hover:text-white transition">
                <Facebook size={18} />
              </a>
              <a href="#" target="_blank" className="text-zinc-400 hover:text-white transition">
                <Instagram size={18} />
        ...
        {/* BOTTOM */}
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-400 text-sm">
