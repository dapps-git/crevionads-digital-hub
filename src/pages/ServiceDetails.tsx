...
// --- CUSTOM CSS MOCKUPS FOR VISUAL EXCELLENCE ---
...
const BrowserMockup = () => (
  <div className="relative w-full aspect-[16/10] bg-black/40 rounded-2xl border border-white/10 overflow-hidden shadow-2xl backdrop-blur-xl">
    ...
    <div className="p-6 font-mono text-[9px] sm:text-xs text-zinc-400 space-y-3 flex flex-col justify-center h-[calc(100%-40px)]">
      <div className="flex gap-2"><span className="text-zinc-600">01</span><span className="text-purple-400">const</span><span> crevionApp = <span className="text-[#F4CE45]">new</span> CrevionDigitalHub();</span></div>
      <div className="flex gap-2"><span className="text-zinc-600">02</span><span className="text-purple-400">await</span><span> crevionApp.initialize(&#123;</span></div>
      <div className="flex gap-2"><span className="text-zinc-600">03</span><span className="pl-4 text-zinc-500">uxFocus:</span><span className="text-[#F4CE45]"> "absolute-perfection"</span><span>,</span></div>
      <div className="flex gap-2"><span className="text-zinc-600">04</span><span className="pl-4 text-zinc-500">performance:</span><span className="text-[#F4CE45]"> "light-speed"</span><span>,</span></div>
      <div className="flex gap-2"><span className="text-zinc-600">05</span><span className="pl-4 text-zinc-500">security:</span><span className="text-[#F4CE45]"> "military-grade"</span></div>
      ...
      <div className="absolute bottom-4 right-4 p-3 bg-[#0a0616]/80 border border-white/10 flex items-center gap-3 rounded-xl shadow-lg backdrop-blur-sm">
...
const DashboardMockup = () => (
  <div className="relative w-full aspect-[16/10] bg-black/40 rounded-2xl border border-white/10 overflow-hidden shadow-2xl backdrop-blur-xl p-4 sm:p-6 flex flex-col gap-4">
    <div className="flex justify-between items-center pb-3 border-b border-white/10">
      ...
      <span className="text-[8px] bg-purple-500/10 text-purple-400 border border-purple-500/20 px-2 py-0.5 rounded-full font-bold uppercase tracking-widest">Active</span>
    </div>
    <div className="grid grid-cols-3 gap-3">
      <div className="p-3 bg-white/5 border border-white/5 rounded-xl flex flex-col gap-1">
        ...
        <span className="text-xs sm:text-sm font-bold text-[#F4CE45] font-sans">100/100</span>
      </div>
      <div className="p-3 bg-white/5 border border-white/5 rounded-xl flex flex-col gap-1">
      ...
      <div className="p-3 bg-white/5 border border-white/5 rounded-xl flex flex-col gap-1">
        ...
        <span className="text-xs sm:text-sm font-bold text-purple-400 font-sans">12ms</span>
      </div>
    </div>
    <div className="flex-grow flex items-end gap-2 pt-2">
      <div className="w-full bg-white/5 border border-white/5 rounded-t h-[40%] hover:bg-purple-500/30 transition-colors" />
      <div className="w-full bg-white/5 border border-white/5 rounded-t h-[60%] hover:bg-purple-500/30 transition-colors" />
      <div className="w-full bg-white/5 border border-white/5 rounded-t h-[50%] hover:bg-purple-500/30 transition-colors" />
      <div className="w-full bg-white/5 border border-white/5 rounded-t h-[80%] hover:bg-purple-500/30 transition-colors" />
      <div className="w-full bg-white/5 border border-white/5 rounded-t h-[95%] hover:bg-purple-500/30 transition-colors" />
      <div className="w-full bg-white/5 border border-white/5 rounded-t h-[75%] hover:bg-purple-500/30 transition-colors" />
    </div>
  </div>
);
  ...
  <div className="relative w-full aspect-[16/10] bg-black/40 rounded-2xl border border-white/10 overflow-hidden shadow-2xl backdrop-blur-xl p-4 sm:p-6 flex flex-col justify-between gap-3">
    ...
    <div className="flex-grow flex flex-col justify-center gap-3">
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-[9px] text-purple-400 font-mono font-bold">85%</span>
      </div>
      <div className="flex items-center justify-between gap-3">
        <span className="text-[9px] text-zinc-400 font-mono font-bold w-1/3">Organic SEO</span>
        <div className="w-1/2 h-2 bg-zinc-700 rounded-full overflow-hidden">
          <div className="h-full bg-[#F4CE45] w-[75%]" />
        </div>
        <span className="text-[9px] text-[#F4CE45] font-mono font-bold">75%</span>
      </div>
      <div className="flex items-center justify-between gap-3">
...
const BrandingMockup = () => (
  <div className="relative w-full aspect-[16/10] bg-black/40 rounded-2xl border border-white/10 overflow-hidden shadow-2xl backdrop-blur-xl p-4 sm:p-6 flex flex-col gap-4 items-center justify-center">
    <div className="w-20 h-20 rounded-full border border-white/10 flex items-center justify-center bg-gradient-to-tr from-purple-600/20 to-[#F4CE45]/20 relative">
...
const PhoneMockup = () => (
  <div className="relative w-44 sm:w-52 aspect-[9/18] bg-black/90 rounded-[35px] border-[6px] border-zinc-800/80 overflow-hidden shadow-2xl flex flex-col p-4 gap-4">
    ...
    <div className="p-3 bg-white/5 border border-white/5 rounded-2xl flex flex-col gap-1">
      ...
      <span className="text-xs font-bold text-purple-400 font-sans">+18.24% ROI</span>
    </div>
    <div className="flex-grow flex items-center justify-center">
      <div
        className="w-16 h-16 rounded-full border-4 border-amber-400/20 border-t-amber-400 flex items-center justify-center relative animate-spin"
...
const ServiceDetails = () => {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-zinc-400 text-sm font-medium">Loading service details...</p>
        </div>
      </div>
    );
  }
  ...
  const renderMockup = (type: string) => {
    if (service.image) {
      const isVideo = /\.(mp4|webm|ogg|mov)$/i.test(service.image);
      if (isVideo) {
        return (
          <div className="relative w-full aspect-[16/10] bg-black/40 rounded-2xl border border-white/10 overflow-hidden shadow-2xl backdrop-blur-xl flex items-center justify-center">
            <video 
              src={service.image} 
        ...
        return (
          <div className="relative w-full aspect-[16/10] bg-black/40 rounded-2xl border border-white/10 overflow-hidden shadow-2xl backdrop-blur-xl flex items-center justify-center p-2">
            <img 
              src={service.image} 
              alt={service.title} 
    ...
    <div className="min-h-screen bg-background pt-24 overflow-x-hidden font-sans">
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={() => navigate("/")}
            className="inline-flex items-center text-zinc-500 hover:text-amber-400 transition-colors mb-6 group text-xs font-semibold uppercase tracking-wider"
          >
            <ArrowLeft className="mr-2 h-3.5 w-3.5 transform group-hover:-translate-x-1 transition-transform" />
            Home / Services / <span className="text-zinc-300 ml-1 font-bold">{service.title}</span>
          </button>
            ...
            <div className="lg:col-span-5 space-y-3">
              {config.highlights.map((h, i) => (
                <motion.div
                  ...
                  className="bg-white/[0.02] border border-white/5 rounded-2xl p-4 flex gap-4 hover:border-purple-500/20 hover:bg-white/[0.04] transition-all duration-300 group"
                >
                  <div className="w-9 h-9 rounded-xl bg-purple-950/40 border border-purple-800/30 flex items-center justify-center text-amber-400 font-bold font-sans text-sm flex-shrink-0 group-hover:scale-105 transition-transform">
                    {`0${i + 1}`}
                  </div>
                  <div className="flex-1 flex flex-col gap-1">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-100 group-hover:text-amber-400 transition-colors">
                      {h.label}
                    </h3>
                    <p className="text-[10px] sm:text-xs text-zinc-500 font-medium leading-relaxed">
                      {h.desc}
                    </p>
                  </div>
                </motion.div>
      ...
      <section className="py-12 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div className="space-y-4 text-left">
            <span className="text-amber-400 text-[9px] font-bold uppercase tracking-[0.25em]">
              Deep Dive
            </span>
            <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-white">
              {config.subtitle}
            </h2>
            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed whitespace-pre-wrap font-light">
      ...
      {/* --- SECTION 2: EXCELLENCE ACCENT BANNER --- */}
      <section className="py-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-xl p-7 sm:p-10 flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 rounded-full bg-purple-900/10 blur-[100px] pointer-events-none" />

          <div className="flex-1 text-left space-y-4 relative z-10">
            <span className="text-purple-400 text-[9px] font-bold uppercase tracking-[0.25em]">
              Our Guarantee
            </span>
          ...
          <div className="relative z-10 flex-shrink-0 lg:mr-4">
            <PhoneMockup />
          </div>
        </div>
      </section>

      {/* --- SECTION 3: CHECKLIST BLOCK 1 --- */}
      <section className="py-12 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div className="space-y-3 pt-2">
              {config.checklist1.map((item, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <span className="text-zinc-300 text-xs sm:text-sm font-medium leading-relaxed">{item}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      {matchingWorks && matchingWorks.length > 0 && (
        <section className="py-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <span className="inline-block px-4 py-1.5 rounded-full bg-purple-950/40 border border-purple-800/30 text-purple-400 text-[10px] font-bold uppercase tracking-widest mb-4">
              Our Portfolio
            </span>
            ...
            <p className="text-zinc-400 max-w-xl mx-auto text-sm leading-relaxed font-light">
              Discover how we've helped businesses succeed with our top-tier{" "}
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-5 mt-8">
            {matchingWorks.map((w: any, i: number) => (
              <motion.div
                ...
                className="group relative flex items-center justify-center bg-white border border-white/10 rounded-xl aspect-[16/9] w-24 sm:w-32 md:w-40 lg:w-48 p-2 sm:p-3 overflow-hidden shadow-lg hover:scale-[1.02] transition-all duration-300 flex-shrink-0"
              >
                <img
                  src={w.image}
                  alt={w.title}
      ...
      {/* --- CTA FOOTER --- */}
      <section className="py-14 text-center relative z-10">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-zinc-400 text-sm font-light max-w-xl mx-auto mb-8 leading-relaxed">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-[#F4CE45] hover:bg-[#ffe374] text-[#05030A] font-bold text-sm transition-all duration-300 shadow-lg hover:scale-[1.02]"
          >
